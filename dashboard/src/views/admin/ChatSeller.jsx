        ...
        <div className="flex w-full h-full relative">
          ...
          >
            <div className="w-full h-[calc(100vh-177px)] bg-[#252b3b] md:bg-transparent overflow-y-auto">
              ...
              <div
                className={`h-[60px] flex justify-start gap-2 items-center text-white px-2 rounded-sm py-2 cursor-pointer bg-slate-700 `}
              >
                ...
                <div className="flex justify-center items-start flex-col w-full">
                  <div className="flex justify-between items-center w-full">
                    <h2 className="text-base font-semibold">Ashikur Rafi</h2>
                  </div>
                </div>
              </div>
              <div
            ...
            <div className="flex justify-between items-center">
              {sellerId && (
                <div className="flex justify-start items-center gap-3">
                  ...
                  <h2 className="text-base text-white font-semibold">Ashik</h2>
                </div>
              )}
              <div
                onClick={() => setShow(!show)}
